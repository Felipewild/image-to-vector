...
public class Pixel {
    ...
    public Pixel(int rgb, boolean is_argb) {
        this.rgb = new short[3];
        if (is_argb) {
            this.rgb[0] = (short) ((rgb >> 24) & 0x000000FF); //red
            this.rgb[1] = (short) ((rgb >> 16) & 0x000000FF); //green
            this.rgb[2] = (short) ((rgb >> 8) & 0x000000FF); //blue
        } else {
